...
class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate, NSWindowDelegate {
    ...
    func setupMenuBar() {
        ...
        if let button = statusItem?.button {
            button.image = NSImage(systemSymbolName: "antenna.radiowaves.left.and.right.slash", accessibilityDescription: "KonnectMac")
            button.target = self
    ...
    private func updateStatusBarIcon(devices: [String: Device]) {
        ...
        button.image = NSImage(systemSymbolName: iconName, accessibilityDescription: "KonnectMac")
    }
